FactoryGirl.define do
  ...
  # In the case above, FactoryGirl will create new user and campaign records before create the pledge so the created pledge will be associated with the newly created user and campaign.
