...
RSpec.describe Api::V1::CampaignsController, type: :controller do
  ...
  # By default Controller Specs don't render views (for speed and separation purposes). In here we need to have the controller spec render views because for the index action we're using jBuilder which is a view to render JSON.
  render_views
  # ^ used for jbuilder
